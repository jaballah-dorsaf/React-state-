...
export default function Admin() {
  const [listHotel, setListHotel] = useState([
    ...
    {
      titre: "Iberostar Mehari Djerba",
      adresse:" Route Touristique 04116, 4116 Taguermess, Tunisie",
      ville: "Djerba",
      description:
        "L'hôtel tout compris Iberostar est situé sur l'île de Djerba, à côté de la plage de Sidi Akkour et en face du Djerba Golf Club. Il comprend 2 piscines, un spa et des courts de tennis. L'Iberostar Mehari Djerba propose un hébergement tout compris avec climatisation .",
      image: "https://r-cf.bstatic.com/images/hotel/max1024x768/183/183661757.jpg",
      rating: 4
    }
